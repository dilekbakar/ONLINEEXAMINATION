...
namespace OnlineSinav.Data.Data
{
    public class OnlineSinavDBContext : DbContext
    {
        public OnlineSinavDBContext(DbContextOptions<OnlineSinavDBContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QnAs>(entity =>
            {
                ...
                entity.Property(e => e.Option5).IsRequired().HasMaxLength(50);
